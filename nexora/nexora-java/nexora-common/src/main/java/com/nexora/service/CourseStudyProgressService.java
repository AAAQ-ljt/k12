...
public interface CourseStudyProgressService {
	 ...
	 * 根据Id查询对象
	 */
	CourseStudyProgress getCourseStudyProgressById(Integer id);


	/**
	 * 根据Id修改
	 */
	Integer updateCourseStudyProgressById(CourseStudyProgress bean,Integer id);


	/**
	 * 根据Id删除
	 */
	Integer deleteCourseStudyProgressById(Integer id);
