...
import com.nexora.mappers.CourseStudyLessonProgressMapper;
...
public class CourseStudyLessonProgressServiceImpl implements CourseStudyLessonProgressService {
	 ...
	 */
	@Override
	public CourseStudyLessonProgress getCourseStudyLessonProgressById(Integer id) {
	 ...
	 */
	@Override
	public Integer updateCourseStudyLessonProgressById(CourseStudyLessonProgress bean, Integer id) {
	 ...
	 */
	@Override
	public Integer deleteCourseStudyLessonProgressById(Integer id) {
	 ...
	 */
	@Override
	public CourseStudyLessonProgress getCourseStudyLessonProgressByUserIdAndLessonId(String userId, String lessonId) {
	 ...
	 */
	@Override
	public Integer updateCourseStudyLessonProgressByUserIdAndLessonId(CourseStudyLessonProgress bean, String userId, String lessonId) {
	 ...
	 */
	@Override
	public Integer deleteCourseStudyLessonProgressByUserIdAndLessonId(String userId, String lessonId) {
