...
import com.nexora.mappers.SystemMenuMapper;
...
public class SystemMenuServiceImpl implements SystemMenuService {
	...
	public PaginationResultVO<SystemMenu> findListByPage(SystemMenuQuery param) {
		...
		PaginationResultVO<SystemMenu> result = new PaginationResultVO(count, page.getPageSize(), page.getPageNo(), page.getPageTotal(), list);
		return result;
	}
	 ...
	 */
	@Override
	public Integer updateSystemMenuByMenuCode(SystemMenu bean, String menuCode) {
		return this.systemMenuMapper.updateByMenuCode(bean, menuCode);
	}
	 ...
	 */
	@Override
	public Integer deleteSystemMenuByMenuCode(String menuCode) {
		return this.systemMenuMapper.deleteByMenuCode(menuCode);
	}
}