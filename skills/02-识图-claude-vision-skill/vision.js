#!/usr/bin/env node
/**
 * 独立识图脚本 — 调用阿里云百炼 vision 模型（qwen3.7-flash-2026-07-15），按量付费。
 *
 * 用法:
...
const API_KEY = process.env.DASHSCOPE_API_KEY || "sk-ws-H.EEMPHIE.NBVZ.MEUCIQCJIclSTFr1cxgt6_H7W-7QTtDhIQ4q3DXIMw-ElWxukwIgPKLEd_y49yOl7ZEMK6HABPP9A5JXcd1gu9FEhNVTBZU";
