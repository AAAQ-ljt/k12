...
public interface SystemNoticeService {
	 ...
	 * 根据NoticeId查询对象
	 */
	SystemNotice getSystemNoticeByNoticeId(String noticeId);


	/**
	 * 根据NoticeId修改
	 */
	Integer updateSystemNoticeByNoticeId(SystemNotice bean,String noticeId);


	/**
	 * 根据NoticeId删除
	 */
	Integer deleteSystemNoticeByNoticeId(String noticeId);
